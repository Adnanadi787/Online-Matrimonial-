...
<form action="search_result.php" method="get" style="width:930px; text-align:center; color: #222f3e;background-color: #ebd8d9;" >
        <fieldset style="text-align:center;">
            <h1 style="text-align:center; background-color: #222f3e; color: #f1c40f">Partner Preference </h1>
...
<tr>
      ...
      <tr>
                   <td colspan="2" style="text-align:center;">
                    <br>
                       <input type="submit" value="Search" style="background-color: #222f3e; color:#f1c40f; width: 80px; height: 30px;">
